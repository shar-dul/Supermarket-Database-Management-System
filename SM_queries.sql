...
-- Insert a new product into the products table: eg. A new bottle which costs Rs. 150 which 
...
-- Insert a new supplier into the suppliers table: eg. Swara Tripathi who supplies bottles
INSERT INTO supplier
VALUES("S111", "Swara", "Tripathi", 8999234116, "Tripathi Plastics, Vasant Kunj, Delhi");

-- Insert a new customer into the customers table: eg. Vidit Shukla 
INSERT INTO customer
VALUES("C111", "Vidit", "Shukla", 6669981200, "701, Tailwind, Bhusari Colony");

-- Insert a new employee into the employees table: eg. Sharad Shelke
...
-- Insert a new purchase into the purchases table, including the supplier ID, the product ID, and the date of the purchase:
...
-- Insert a new sale into the sales table, including the customer ID, the product ID, and the date of the sale:
...
-- Update the quantity in stock for a specific product in the products table: eg. Since Vidit Shukla bought 3 bottles, now we have 3
--     less bottles left in quantity
UPDATE product 
SET Quantity=Quantity-3 
WHERE Prod_id="P111";

-- Update the contact information for a specific supplier in the suppliers table:
--     eg. Changing phone number of Ashish Joshi from 9908745362 to 9563259001
UPDATE supplier 
SET SuppContact=9563459001 
WHERE Supp_id="S107";

-- Update the job position for a specific employee in the employees table:
--     eg. Changing job position of employee Advait Kelkar from Staff to Manager
UPDATE employee 
SET EmpPosition="Manager" 
WHERE Emp_id="E110";

-- Delete a specific sale from the sales table based on the sale ID:
